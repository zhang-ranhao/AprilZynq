...
proc create_root_design { parentCell } {
  ...
  set uav_uart [ create_bd_intf_port -mode Master -vlnv xilinx.com:interface:uart_rtl:1.0 uav_uart ]


  # Create ports
  set o_m_data_0 [ create_bd_port -dir O -from 7 -to 0 o_m_data_0 ]
  set o_m_fstart_0 [ create_bd_port -dir O o_m_fstart_0 ]
  set o_m_last_0 [ create_bd_port -dir O o_m_last_0 ]
  set o_m_valid_0 [ create_bd_port -dir O o_m_valid_0 ]
  ...
  # Create instance: De_Resolution_0, and set properties
  set block_name De_Resolution
  set block_cell_name De_Resolution_0
  if { [catch {set De_Resolution_0 [create_bd_cell -type module -reference $block_name $block_cell_name] } errmsg] } {
     catch {common::send_gid_msg -ssname BD::TCL -id 2095 -severity "ERROR" "Unable to add referenced block <$block_name>. Please add the files for ${block_name}'s definition into the project."}
     return 1
   } elseif { $De_Resolution_0 eq "" } {
     catch {common::send_gid_msg -ssname BD::TCL -id 2096 -severity "ERROR" "Unable to referenced block <$block_name>. Please add the files for ${block_name}'s definition into the project."}
     return 1
   }
  
  # Create instance: GaussBlur_0, and set properties
  set block_name GaussBlur
  set block_cell_name GaussBlur_0
  if { [catch {set GaussBlur_0 [create_bd_cell -type module -reference $block_name $block_cell_name] } errmsg] } {
     catch {common::send_gid_msg -ssname BD::TCL -id 2095 -severity "ERROR" "Unable to add referenced block <$block_name>. Please add the files for ${block_name}'s definition into the project."}
     return 1
   } elseif { $GaussBlur_0 eq "" } {
     catch {common::send_gid_msg -ssname BD::TCL -id 2096 -severity "ERROR" "Unable to referenced block <$block_name>. Please add the files for ${block_name}'s definition into the project."}
     return 1
   }
  ...
  set_property -dict [ list \
   ...
   CONFIG.c_mm2s_genlock_mode {0} \
   CONFIG.c_s2mm_genlock_mode {0} \
   CONFIG.c_s2mm_linebuffer_depth {65536} \
   CONFIG.c_s2mm_max_burst_length {128} \
 ] $axi_vdma_2
  ...
  set_property -dict [ list \
   ...
   CONFIG.S_AXIS_VIDEO_DATA_WIDTH {10} \
  ...
  connect_bd_intf_net -intf_net S_AXIS_S2MM_0_1 [get_bd_intf_ports S_AXIS_S2MM_0] [get_bd_intf_pins axi_vdma_2/S_AXIS_S2MM]
  ...
  connect_bd_intf_net -intf_net axis_broadcaster_0_M01_AXIS [get_bd_intf_pins axis_broadcaster_0/M01_AXIS] [get_bd_intf_pins v_rgb2ycrcb_0/video_in]
  connect_bd_intf_net -intf_net axis_broadcaster_1_M01_AXIS [get_bd_intf_pins axi_vdma_1/S_AXIS_S2MM] [get_bd_intf_pins axis_broadcaster_1/M01_AXIS]
  ...
  connect_bd_intf_net -intf_net axis_subset_converter_1_M_AXIS [get_bd_intf_pins axis_broadcaster_1/S_AXIS] [get_bd_intf_pins axis_subset_converter_1/M_AXIS]
  ...
  connect_bd_intf_net -intf_net ps8_0_axi_periph_M01_AXI [get_bd_intf_pins ps8_0_axi_periph/M01_AXI] [get_bd_intf_pins v_demosaic_0/s_axi_CTRL]
  connect_bd_intf_net -intf_net ps8_0_axi_periph_M02_AXI [get_bd_intf_pins ps8_0_axi_periph/M02_AXI] [get_bd_intf_pins v_gamma_lut_0/s_axi_CTRL]
  ...
  connect_bd_intf_net -intf_net ps8_0_axi_periph_M04_AXI [get_bd_intf_pins axi_vdma_1/S_AXI_LITE] [get_bd_intf_pins ps8_0_axi_periph/M04_AXI]
  connect_bd_intf_net -intf_net ps8_0_axi_periph_M05_AXI [get_bd_intf_pins axi_vdma_2/S_AXI_LITE] [get_bd_intf_pins ps8_0_axi_periph/M05_AXI]
  ...
  connect_bd_intf_net -intf_net zynq_ultra_ps_e_0_UART_0 [get_bd_intf_ports uav_uart] [get_bd_intf_pins zynq_ultra_ps_e_0/UART_0]

  # Create port connections
  connect_bd_net -net De_Resolution_0_DE_REL_DATA [get_bd_pins De_Resolution_0/DE_REL_DATA] [get_bd_pins GaussBlur_0/i_s_data]
  connect_bd_net -net De_Resolution_0_DE_REL_VALID [get_bd_pins De_Resolution_0/DE_REL_VALID] [get_bd_pins GaussBlur_0/i_s_valid]
  connect_bd_net -net De_Resolution_0_O_FSTART [get_bd_pins De_Resolution_0/O_FSTART] [get_bd_pins GaussBlur_0/i_s_fstart]
  connect_bd_net -net De_Resolution_0_O_TLAST [get_bd_pins De_Resolution_0/O_TLAST] [get_bd_pins GaussBlur_0/i_s_last]
  connect_bd_net -net De_Resolution_0_TREADY [get_bd_pins De_Resolution_0/TREADY] [get_bd_pins axis_broadcaster_1/m_axis_tready]
  connect_bd_net -net GaussBlur_0_o_m_data [get_bd_ports o_m_data_0] [get_bd_pins GaussBlur_0/o_m_data]
  connect_bd_net -net GaussBlur_0_o_m_fstart [get_bd_ports o_m_fstart_0] [get_bd_pins GaussBlur_0/o_m_fstart]
  connect_bd_net -net GaussBlur_0_o_m_last [get_bd_ports o_m_last_0] [get_bd_pins GaussBlur_0/o_m_last]
  connect_bd_net -net GaussBlur_0_o_m_valid [get_bd_ports o_m_valid_0] [get_bd_pins GaussBlur_0/o_m_valid]
  ...
  connect_bd_net -net axis_broadcaster_1_m_axis_tdata [get_bd_pins De_Resolution_0/TDATA] [get_bd_pins axis_broadcaster_1/m_axis_tdata]
  connect_bd_net -net axis_broadcaster_1_m_axis_tlast [get_bd_pins De_Resolution_0/TLAST] [get_bd_pins axis_broadcaster_1/m_axis_tlast]
  connect_bd_net -net axis_broadcaster_1_m_axis_tuser [get_bd_pins De_Resolution_0/FSTART] [get_bd_pins axis_broadcaster_1/m_axis_tuser]
  connect_bd_net -net axis_broadcaster_1_m_axis_tvalid [get_bd_pins De_Resolution_0/TVALID] [get_bd_pins axis_broadcaster_1/m_axis_tvalid]
  ...
  connect_bd_net -net proc_sys_reset_150M_peripheral_aresetn [get_bd_ports peripheral_aresetn] [get_bd_pins De_Resolution_0/ARESET] [get_bd_pins GaussBlur_0/rst_n] [get_bd_pins axi_interconnect_0/M00_ARESETN] [get_bd_pins axi_interconnect_0/S00_ARESETN] [get_bd_pins axi_interconnect_0/S01_ARESETN] [get_bd_pins axi_interconnect_0/S02_ARESETN] [get_bd_pins axi_vdma_0/axi_resetn] [get_bd_pins axi_vdma_1/axi_resetn] [get_bd_pins axi_vdma_2/axi_resetn] [get_bd_pins axis_broadcaster_0/aresetn] [get_bd_pins axis_broadcaster_1/aresetn] [get_bd_pins axis_subset_converter_0/aresetn] [get_bd_pins axis_subset_converter_1/aresetn] [get_bd_pins mipi_csi2_rx_subsyst_0/lite_aresetn] [get_bd_pins mipi_csi2_rx_subsyst_0/video_aresetn] [get_bd_pins proc_sys_reset_150M/peripheral_aresetn] [get_bd_pins ps8_0_axi_periph/M00_ARESETN] [get_bd_pins ps8_0_axi_periph/M01_ARESETN] [get_bd_pins ps8_0_axi_periph/M02_ARESETN] [get_bd_pins ps8_0_axi_periph/M03_ARESETN] [get_bd_pins ps8_0_axi_periph/M04_ARESETN] [get_bd_pins ps8_0_axi_periph/M05_ARESETN] [get_bd_pins ps8_0_axi_periph/S00_ARESETN] [get_bd_pins v_demosaic_0/ap_rst_n] [get_bd_pins v_gamma_lut_0/ap_rst_n] [get_bd_pins v_rgb2ycrcb_0/aresetn]
  ...
  connect_bd_net -net xlconstant_0_dout [get_bd_pins GaussBlur_0/i_m_ready] [get_bd_pins xlconstant_0/dout]
  connect_bd_net -net zynq_ultra_ps_e_0_pl_clk0 [get_bd_ports pl_clk0] [get_bd_pins De_Resolution_0/ACLK] [get_bd_pins GaussBlur_0/clk] [get_bd_pins axi_interconnect_0/ACLK] [get_bd_pins axi_interconnect_0/M00_ACLK] [get_bd_pins axi_interconnect_0/S00_ACLK] [get_bd_pins axi_interconnect_0/S01_ACLK] [get_bd_pins axi_interconnect_0/S02_ACLK] [get_bd_pins axi_vdma_0/m_axi_s2mm_aclk] [get_bd_pins axi_vdma_0/s_axi_lite_aclk] [get_bd_pins axi_vdma_0/s_axis_s2mm_aclk] [get_bd_pins axi_vdma_1/m_axi_s2mm_aclk] [get_bd_pins axi_vdma_1/s_axi_lite_aclk] [get_bd_pins axi_vdma_1/s_axis_s2mm_aclk] [get_bd_pins axi_vdma_2/m_axi_s2mm_aclk] [get_bd_pins axi_vdma_2/s_axi_lite_aclk] [get_bd_pins axi_vdma_2/s_axis_s2mm_aclk] [get_bd_pins axis_broadcaster_0/aclk] [get_bd_pins axis_broadcaster_1/aclk] [get_bd_pins axis_subset_converter_0/aclk] [get_bd_pins axis_subset_converter_1/aclk] [get_bd_pins mipi_csi2_rx_subsyst_0/lite_aclk] [get_bd_pins mipi_csi2_rx_subsyst_0/video_aclk] [get_bd_pins proc_sys_reset_150M/slowest_sync_clk] [get_bd_pins ps8_0_axi_periph/ACLK] [get_bd_pins ps8_0_axi_periph/M00_ACLK] [get_bd_pins ps8_0_axi_periph/M01_ACLK] [get_bd_pins ps8_0_axi_periph/M02_ACLK] [get_bd_pins ps8_0_axi_periph/M03_ACLK] [get_bd_pins ps8_0_axi_periph/M04_ACLK] [get_bd_pins ps8_0_axi_periph/M05_ACLK] [get_bd_pins ps8_0_axi_periph/S00_ACLK] [get_bd_pins v_demosaic_0/ap_clk] [get_bd_pins v_gamma_lut_0/ap_clk] [get_bd_pins v_rgb2ycrcb_0/aclk] [get_bd_pins zynq_ultra_ps_e_0/maxihpm0_lpd_aclk] [get_bd_pins zynq_ultra_ps_e_0/pl_clk0] [get_bd_pins zynq_ultra_ps_e_0/saxihp0_fpd_aclk]
  ...
  assign_bd_address -offset 0xE0000000 -range 0x10000000 -target_address_space [get_bd_addr_spaces axi_vdma_2/Data_S2MM] [get_bd_addr_segs zynq_ultra_ps_e_0/SAXIGP2/HP0_PCIE_LOW] -force
  ...
  assign_bd_address -offset 0x80030000 -range 0x00010000 -target_address_space [get_bd_addr_spaces zynq_ultra_ps_e_0/Data] [get_bd_addr_segs axi_vdma_2/S_AXI_LITE/Reg] -force
